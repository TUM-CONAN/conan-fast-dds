...
class FastDDSConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("fast-cdr/1.0.27@camposs/stable", transitive_headers=True, transitive_libs=True)
        self.requires("foonathan-memory/0.7.3")
        self.requires("boost/1.81.0")  # boost/1.76 is required by version 2.3.2, boost/1.75.0 required for 2.3.3 by Windows
    ...
    def generate(self):
        ...
        tc.set_property("tinyxml2", "cmake_find_mode", "module")
